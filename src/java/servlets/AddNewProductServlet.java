...
public class AddNewProductServlet extends HttpServlet {
    ...
    /**
     * handles request by admin to add new product Handles the HTTP
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String result = ProductCatalogueDAO.addNewProduct(conn, code, name, price, taxable);

        session.setAttribute("resultAddProd", result);
